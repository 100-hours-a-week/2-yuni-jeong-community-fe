export const initializeProfilePhoto = (profilePhotoInput, profilePhotoContainer, profilePhotoHelper, plusIcon) => {
    // 프로필 사진 변경
    profilePhotoInput?.addEventListener("change", () => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                if (profilePhotoHelper) profilePhotoHelper.style.display = "none";
            };
